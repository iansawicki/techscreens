...
# Streamlit stuff
st.title("LLM Agent Assisted Data Explorer")
...
tab1, tab2, tab3 = st.tabs(["API-->CSV Exporter", "Agent Assisted Data Explorer", "Summary Report & Review"])
...
with tab1:
    ...
    st.write("With customer id:", selected_customer_id)
